...
getgenv().AEKaitun = {
    ...
    DumpUnitType = PlacementEngine.dumpUnitType,
    IsMagical = PlacementEngine.isMagicalUnit,
    ...
    SellDuplicates = Summon.sellDuplicateLegendaries,
    SellDuplicateRarities = Summon.sellDuplicateUnits,
